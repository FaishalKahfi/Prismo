document.addEventListener("DOMContentLoaded", function () {
    ...
    function highlightText(element, query) {
        ...
        if (!questionSpan.innerHTML.includes("<mark")) {
            ...
            questionSpan.innerHTML = questionText.replace(
                regex,
...
function contactSupport() {
    // Open WhatsApp to Prismo support number
    window.open(
        "https://wa.me/6282227671561?text=Halo%20Prismo%2C%20saya%20membutuhkan%20bantuan",
        "_blank"
    );
}
