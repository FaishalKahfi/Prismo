...
<body>
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="postalCode" name="postalCode" class="form-control"
                                        placeholder="Contoh: 16340" pattern="[0-9]{5}" maxlength="5" required>
                                    <small class="form-text text-muted">Masukkan 5 digit kode pos</small>
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group">
    ...
    <script>
        ...
        document.getElementById('province').addEventListener('change', function() {
            ...
            // Reset dan disable city
            citySelect.innerHTML = '<option value="">Pilih Kota/Kabupaten</option>';
            citySelect.disabled = true;

            // Restore asterisk pada city
        ...
        // Event listener untuk postal code - validation only
