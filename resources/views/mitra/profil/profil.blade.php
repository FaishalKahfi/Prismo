...
<body>
    ...
    <script>
        ...
        function handleLogout() {
            ...
            .then(response => {
                if (response.ok) {
                    ...
                    // Redirect ke halaman login dengan replace (no back button)
                    window.location.replace('/login');
                } else {
                    // Jika gagal, tetap redirect ke login
                    window.location.replace('/login');
                }
            })
            .catch(error => {
        ...
        // Refund method modal removed - not needed for mitra
    </script>
</body>
</html>
