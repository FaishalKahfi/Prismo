...
<head>
    ...
    <meta property="og:url" content="{{ url('/dashboard-mitra') }}">
    ...
    <link rel="stylesheet" href="{{ asset('css/dashboard.css') }}?v=20251214041932">
            ...
            <div class="header__content">
                <div class="header__left">
                    ...
                    <nav class="nav nav--main" aria-label="Navigasi utama">
                        <a href="{{ url('/dashboard-mitra') }}" class="nav__item nav__item--active" data-page="dashboard">
                            Dashboard
                        </a>
    ...
    <template id="mobileMenuTemplate">
        <div class="mobile-menu" id="mobileMenu">
            ...
            <nav class="mobile-nav" aria-label="Navigasi mobile">
                <a href="{{ url('/dashboard-mitra') }}" class="mobile-nav__item mobile-nav__item--active" data-page="dashboard">
