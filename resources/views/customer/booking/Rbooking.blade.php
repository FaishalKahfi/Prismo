...
<body>
            ...
            <nav class="navbar">
                ...
                <ul class="nav-menu" id="mainNav">
                    <li class="mobile-profile-menu">
                        <div class="user-profile mobile-user-profile" onclick="window.location.href='{{ url('/customer/profil/uprofil') }}'" style="cursor: pointer;">
                            ...
                            @endphp
                            <img src="{{ $avatarUrl }}?v={{ auth()->user()->updated_at->timestamp }}" alt="User" class="user-icon-img" id="mobileBookingProfileImg" onerror="this.src='{{ asset('images/profile.png') }}'">
                            <div class="user-info">
                ...
                <div class="nav-right">
                    ...
                    <div class="user-profile desktop-user-profile" onclick="window.location.href='{{ url('/customer/profil/uprofil') }}'" style="cursor: pointer;">
                        ...
                        @endphp
                        <img src="{{ $avatarUrl }}?v={{ auth()->user()->updated_at->timestamp }}" alt="User" class="user-icon-img" id="bookingProfileImg" onerror="this.src='{{ asset('images/profile.png') }}'">
                        <div class="user-info">
    ...
    <script>
        ...
        window.bookingHistory = @json($bookingHistory->items());
    </script>
