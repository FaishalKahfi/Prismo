...
class ReviewController extends Controller
{
    public function index()
    {
        ...
        $reviews = Review::where('mitra_id', $mitra->id)
            ->with(['customer.customerProfile', 'booking'])
            ...
            ->map(function($review) {
                ...
                return [
                    ...
                    'reviewer' => [
                        ...
                        'avatar' => $review->customer->customerProfile && $review->customer->customerProfile->profile_photo
                            ? (filter_var($review->customer->customerProfile->profile_photo, FILTER_VALIDATE_URL) 
                                ? $review->customer->customerProfile->profile_photo 
                                : (str_starts_with($review->customer->customerProfile->profile_photo, '/') 
                                    ? asset($review->customer->customerProfile->profile_photo) 
                                    : asset('storage/' . $review->customer->customerProfile->profile_photo)))
                            : ($review->customer->avatar 
                                ? (filter_var($review->customer->avatar, FILTER_VALIDATE_URL) 
                                    ? $review->customer->avatar 
                                    : (str_starts_with($review->customer->avatar, '/') 
