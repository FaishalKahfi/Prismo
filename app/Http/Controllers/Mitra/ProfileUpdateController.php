...
class ProfileUpdateController extends Controller
{
    ...
    public function updateOperationalHours(Request $request)
    {
        try {
            ...
            if ($user->role !== 'mitra') {
                return response()->json(['success' => false, 'message' => 'Unauthorized - Not a mitra'], 403);
            }
            ...
            Log::error('Error updating operational hours', [
                'error' => $e->getMessage(),
            ...
            return response()->json([
                'success' => false,
                'message' => 'Terjadi kesalahan saat menyimpan jam operasional: ' . $e->getMessage()
            ], 500);
        }
    }
