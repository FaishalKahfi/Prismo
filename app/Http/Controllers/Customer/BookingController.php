...
class BookingController extends Controller
{
    public function index()
    {
        ...
        if ($currentBooking) {
            ...
            $currentBookingData = [
                'id' => $currentBooking->id, // Use numeric ID for API calls
                'bookingCode' => $currentBooking->booking_code, // Keep booking code for display
        ...
        // Booking history (status: selesai, dibatalkan) with pagination
        ...
        $bookingHistory->getCollection()->transform(function($booking) {
                ...
                return (object) [
                    'id' => $booking->id, // Use numeric ID for API calls
                    'bookingCode' => $booking->booking_code, // Keep booking code for display
                    'mitraId' => $booking->mitra_id,
    ...
    public function reschedule(Request $request)
    {
        ...
        return response()->json([
            ...
            'data' => [
                ...
                'new_date' => Carbon::parse($booking->booking_date)->format('Y-m-d'),
    ...
    public function submitReview(Request $request)
    {
        ...
        // Send notification to mitra about new review
        \App\Services\NotificationService::create(
            $booking->mitra_id,
            'review_new',
            'Review Baru Diterima',
            "{$user->name} memberikan review {$validated['rating']} bintang untuk layanan Anda.",
            $booking->id
        );
