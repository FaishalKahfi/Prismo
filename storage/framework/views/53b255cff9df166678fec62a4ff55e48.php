...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/saldo.css')); ?>">
...
<body>
            ...
            <div class="header__content">
                <div class="header__left">
                    ...
                    <nav class="nav nav--main" aria-label="Navigasi utama">
                        <a href="<?php echo e(url('/dashboard-mitra')); ?>" class="nav__item" data-page="dashboard">
                            Dashboard
                        </a>
                ...
                <div class="user-menu">
                    <button class="user-menu__toggle" aria-expanded="false" aria-label="Menu pengguna">
                        <div class="avatar">
                            <img src="<?php echo e(asset(auth()->user()->avatar ?? 'images/profile.png')); ?>?v=<?php echo e(auth()->user()->updated_at->timestamp); ?>"
            ...
            <section class="saldo-section">
                <div class="saldo-card">
                    ...
                    <div class="saldo-amount">
                        <span class="saldo-number">Rp<?php echo e(number_format($availableBalance, 0, ',', '.')); ?></span>
                    ...
                    <div class="pendapatan-hari-ini">
                        ...
                        <div class="pendapatan-details">
                            ...
                            <div class="pendapatan-item">
                                ...
                                <span class="saldo-bersih">Rp<?php echo e(number_format($todayEarnings, 0, ',', '.')); ?></span>
                            </div>
                            <div class="pendapatan-item total-pendapatan">
                                <span>Total Pendapatan</span>
                                <span class="total-pendapatan-amount">Rp<?php echo e(number_format($todayEarnings, 0, ',', '.')); ?></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="saldo-actions">
                        <a href="<?php echo e(url('/mitra/saldo/history')); ?>" class="btn btn--secondary">
                            Laporan Keuangan
                        </a>
    ...
    <template id="mobileMenuTemplate">
        <div class="mobile-menu" id="mobileMenu">
            ...
            <nav class="mobile-nav" aria-label="Navigasi mobile">
                <a href="<?php echo e(url('/dashboard-mitra')); ?>" class="mobile-nav__item" data-page="dashboard">
    ...
    <script>
        ...
        window.availableBalance = <?php echo json_encode($availableBalance, 15, 512) ?>;
        window.totalEarnings = <?php echo json_encode($totalEarnings, 15, 512) ?>;
        window.totalWithdrawn = <?php echo json_encode($totalWithdrawn, 15, 512) ?>;
        window.pendingWithdrawals = <?php echo json_encode($pendingWithdrawals, 15, 512) ?>;
        window.todayEarnings = <?php echo json_encode($todayEarnings, 15, 512) ?>;
        window.hasWithdrawnToday = <?php echo json_encode($hasWithdrawnToday, 15, 512) ?>;
        window.hasProcessingWithdrawal = <?php echo json_encode($hasProcessingWithdrawal, 15, 512) ?>;
    ...
    <script src="<?php echo e(asset('js/saldo.js')); ?>"></script>
    <script>
...
<?php /**PATH C:\Users\Faishal\Documents\prismo - Copy\resources\views/mitra/saldo/saldo.blade.php ENDPATH**/ ?>