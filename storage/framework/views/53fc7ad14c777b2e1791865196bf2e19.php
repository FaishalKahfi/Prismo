...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/form-mitra.css')); ?>">
</head>
...
<body>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="email" id="email" name="email" placeholder="sari@quickclean.com" value="<?php echo e(Auth::user()->email); ?>" readonly style="background-color: #f5f5f5; cursor: not-allowed;" required>
                    ...
                    <section class="form-section">
                            ...
                            <div class="upload-card" id="facilityUpload">
                                <div class="upload-content">
                                    <div class="upload-icon">
                                        <img src="<?php echo e(asset('images/fasilitas.png')); ?>" alt="Fasilitas">
                                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="upload-card" id="legalDocUpload">
                                <div class="upload-content">
                                    <div class="upload-icon">
                                        <img src="<?php echo e(asset('images/dokumen.png')); ?>" alt="Dokumen">
                                    </div>
                                    <div class="upload-text">
                        ...
                        <div class="form-group">
                            ...
                            <div class="upload-card" id="ktpUpload">
                                <div class="upload-content">
                                    <div class="upload-icon">
                                        <img src="<?php echo e(asset('images/ktp.png')); ?>" alt="KTP">
                                    </div>
                                    <div class="upload-text">
    ...
    <script src="<?php echo e(asset('js/form-mitra.js')); ?>"></script>
</body>

</html>
<?php /**PATH C:\Users\Faishal\Documents\prismo - Copy\resources\views/mitra/form-mitra.blade.php ENDPATH**/ ?>