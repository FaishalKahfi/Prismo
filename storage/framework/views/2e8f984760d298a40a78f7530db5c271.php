...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/antrian.css')); ?>">
...
<body>
            ...
            <div class="header__content">
                <div class="header__left">
                    <div class="header__brand">
                        <img src="<?php echo e(asset('images/logo.png')); ?>" alt="PRISMO" class="logo" width="200" height="200">
                    </div>
    ...
    <button type="button" class="custom-date-picker__trigger" id="datePickerTrigger">
        ...
        <span class="custom-date-picker__icon">
            <img src="<?php echo e(asset('images/tanggal.png')); ?>" alt="Pilih tanggal" class="date-icon" width="16" height="16">
        </span>
    </button>
    ...
    <script>
        ...
        window.antrianData = <?php echo json_encode($antrian, 15, 512) ?>;
    </script>
    ...
    <script src="<?php echo e(asset('js/antrian.js')); ?>"></script>
    <script>
...
<?php /**PATH C:\Users\Faishal\Documents\prismo - Copy\resources\views/mitra/antrian/antrian.blade.php ENDPATH**/ ?>