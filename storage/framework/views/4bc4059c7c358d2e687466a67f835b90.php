...
<head>
    ...
    <meta property="og:url" content="<?php echo e(url('/customer/dashboard')); ?>">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/dashU.css')); ?>">
...
<body>
                ...
                <ul class="nav-menu" id="mainNav">
                    <li class="mobile-profile-menu">
                        <div class="user-profile mobile-user-profile" onclick="window.location.href='<?php echo e(url('/customer/profil/uprofil')); ?>'" style="cursor: pointer;">
                            ...
                            ?>
                            <img src="<?php echo e($finalUrl); ?>" alt="User" class="user-icon-img" id="mobileProfileImg" onerror="this.src='<?php echo e(asset('images/profile.png')); ?>'">
                            <div class="user-info">
                                <span class="user-name" id="mobileUserName"><?php echo e(auth()->user()->name); ?></span>
                                <span class="user-role">User</span>
                            </div>
                        </div>
                    </li>
                    <li><a href="<?php echo e(url('/customer/dashboard/dashU')); ?>" class="nav-link active">Beranda</a></li>
                ...
                <div class="nav-right">
                    ...
                    <div class="user-profile desktop-user-profile" onclick="window.location.href='<?php echo e(url('/customer/profil/uprofil')); ?>'" style="cursor: pointer;">
                        <?php
                            ...
                            $finalUrl = $isGoogleAvatar ? $avatarUrl : asset($avatarUrl) . '?v=' . auth()->user()->updated_at->timestamp;
                        ?>
                        <img src="<?php echo e($finalUrl); ?>" alt="User" class="user-icon-img" id="headerProfileImg" onerror="this.src='<?php echo e(asset('images/profile.png')); ?>'">
                        <div class="user-info">
                            <span class="user-name" id="headerUserName"><?php echo e(auth()->user()->name); ?></span>
                            <span class="user-role">User</span>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="coverage-box">
                ...
                <div class="coverage-map">
                    <img src="<?php echo e(asset('images/Peta-Indo1.jpg')); ?>" alt="Peta Indonesia">
                </div>
            </div>
        </div>
    </section>
    ...
    <script>
        ...
        window.servicesData = <?php echo json_encode($mitras, 15, 512) ?>;
    ...
    <script src="<?php echo e(asset('js/dashU.js')); ?>?v=<?php echo e(time()); ?>"></script>
    <script>
...
<?php /**PATH C:\Users\Faishal\Documents\prismo - Copy\resources\views/customer/dashboard/dashU.blade.php ENDPATH**/ ?>