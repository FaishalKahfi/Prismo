...
<body>
    <div class="email-container">
        ...
        <h1>Selamat, <?php echo e($mitra->name); ?>!</h1>
        ...
        <div class="info-box">
            ...
            <ul>
                <li><strong>Nama:</strong> <?php echo e($mitra->name); ?></li>
                <li><strong>Email:</strong> <?php echo e($mitra->email); ?></li>
                <li><strong>Nama Usaha:</strong> <?php echo e($mitra->mitraProfile->business_name ?? 'Belum diatur'); ?></li>
                <li><strong>Status:</strong> <span style="color: #00c853; font-weight: 600;">Aktif</span></li>
            </ul>
        </div>

        <div class="btn-container">
            <a href="<?php echo e(url('/mitra/dashboard')); ?>" class="btn">
        ...
        <div class="footer">
            ...
            <p style="margin-top: 20px;">
                <a href="<?php echo e(url('/')); ?>">Kunjungi Website</a> |
                <a href="<?php echo e(url('/mitra/dashboard')); ?>">Dashboard Mitra</a> |
                <a href="mailto:support@prismo.com">Hubungi Support</a>
            </p>
            <p style="color: #999; font-size: 12px; margin-top: 20px;">
                Email ini dikirim otomatis, mohon tidak membalas email ini.<br>
                © <?php echo e(date('Y')); ?> PRISMO. All rights reserved.
            </p>
        </div>
    </div>
</body>
</html>
<?php /**PATH C:\Users\Faishal\Documents\prismo - Copy\resources\views/emails/mitra-approved.blade.php ENDPATH**/ ?>