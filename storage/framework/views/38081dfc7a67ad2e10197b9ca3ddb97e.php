...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/minipro.css')); ?>?v=<?php echo e(time()); ?>">
</head>
...
<body>
    ...
    <header class="header">
        <div class="header-container">
            ...
            <a href="<?php echo e(url('/customer/dashboard/dashU')); ?>" class="back-btn">← Kembali</a>
        </div>
    </header>
    ...
    <script>
        ...
        window.mitraBusinessData = <?php echo json_encode($business, 15, 512) ?>;
        window.mitraGalleryImages = <?php echo json_encode($galleryImages, 15, 512) ?>;
        window.mitraServices = <?php echo json_encode($services, 15, 512) ?>;
        window.mitraReviews = <?php echo json_encode($reviews, 15, 512) ?>;
    </script>
    <script src="<?php echo e(asset('js/minipro.js')); ?>?v=<?php echo e(time()); ?>"></script>
    <script>
...
<?php /**PATH C:\Users\Faishal\Documents\prismo - Copy\resources\views/customer/detail-mitra/minipro.blade.php ENDPATH**/ ?>