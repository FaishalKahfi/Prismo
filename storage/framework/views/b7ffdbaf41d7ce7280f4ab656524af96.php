...
<head>
  ...
  <link rel="stylesheet" href="<?php echo e(asset('css/kelolabooking.css')); ?>?v=20251214055500" />
  <style>
...
<body>
      ...
      <div class="modal-card">
        <table class="modal-table">
          <tbody>
            ...
            <tr>
              <td class="detail-label">Metode Refund</td>
              <td class="ewallet-cell">
                <span class="ewallet-badge" id="refundMethodBadge">gopay</span>
              </td>
            </tr>
            <tr>
              <td class="detail-label">Nomor Akun Refund</td>
              <td class="payment-info">
                <span id="refundAccountNumber">-</span>
                <button class="btn-copy" title="Salin" id="copyRefundAccountBtn">
  ...
  <div id="notification" class="notification">
    ...
    <script>
        ...
        window.bookingsData = <?php echo json_encode($bookings, 15, 512) ?>;
        console.log('📊 Total bookings loaded:', window.bookingsData.length);
        // Debug: Check if any booking has refund data
        const withRefund = window.bookingsData.filter(b => b.refund_method || b.refund_account_number);
        console.log('📊 Bookings with refund data:', withRefund.length, withRefund);
    </script>
    ...
    <script src="<?php echo e(asset('js/kelolabooking.js')); ?>?v=20251214054000"></script>
</body>
</html>
<?php /**PATH C:\Users\Faishal\Documents\prismo - Copy\resources\views/admin/kelolabooking/kelolabooking.blade.php ENDPATH**/ ?>