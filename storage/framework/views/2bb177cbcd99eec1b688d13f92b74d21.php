...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/booking.css')); ?>?v=<?php echo e(time()); ?>">
    <script>
        // Inject business data from backend
        window.mitraBusinessData = <?php echo json_encode($businessData ?? null, 15, 512) ?>;
    </script>
    <script src="<?php echo e(asset('js/booking.js')); ?>?v=<?php echo e(time()); ?>" defer></script>
</head>
<body>
    <div class="container">
        <!-- Left Section -->
        <div class="left-section">
            <div class="header">
                ...
                <button class="back-btn" onclick="window.location.href='<?php echo e(url('/customer/detail-mitra/minipro/' . $businessData['mitraId'])); ?>'">
            ...
            <div class="form-section">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" id="merek" placeholder="Toyota" oninput="updateSummary()">
                    </div>
                    <div class="form-group">
                        <label class="required">Tipe</label>
                        <input type="text" id="tipe" placeholder="Avanza" oninput="updateSummary()">
                    </div>
                    <div class="form-group">
            ...
            <div class="form-section">
                ...
                <div class="toggle-section">
                    ...
                    <div class="toggle-content">
                        ...
                        <div class="customer-points">Point Anda: <span id="customerPoints"><?php echo e($businessData['customerPoints'] ?? 0); ?></span></div>
                    </div>
        ...
        <div class="modal">
            ...
            <div class="modal-content" id="paymentContent">
                <div class="payment-box">
                    ...
                    <img src="<?php echo e(asset('images/Qris-prismo.png')); ?>" class="qr-code" alt="QR Code Prismo">
...
<?php /**PATH C:\Users\Faishal\Documents\prismo - Copy\resources\views/customer/atur-booking/booking.blade.php ENDPATH**/ ?>