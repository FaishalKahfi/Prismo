...
<div class="card">
    <div class="icon-container">
        <img src="<?php echo e(asset('images/jam-pasir.png')); ?>" alt="gambar jam pasir">
    </div>
...
setInterval(function() {
    fetch('<?php echo e(route("check-approval-status")); ?>', {
        method: 'GET',
        headers: {
    ...
    .then(data => {
        if (data.approval_status === 'approved') {
            window.location.href = '<?php echo e(route("dashboard.mitra")); ?>';
        }
    })
...
<?php /**PATH C:\Users\Faishal\Documents\prismo - Copy\resources\views/mitra/form-mitra-pending.blade.php ENDPATH**/ ?>