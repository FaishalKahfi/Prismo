...
<body>
    ...
    <script>
        ...
        window.reviewsData = <?php echo json_encode($reviews, 15, 512) ?>;
        window.totalReviews = <?php echo json_encode($totalReviews, 15, 512) ?>;
        window.averageRating = <?php echo json_encode($averageRating, 15, 512) ?>;
        window.ratingDistribution = <?php echo json_encode($ratingDistribution, 15, 512) ?>;
    </script>
...
<?php /**PATH C:\Users\Faishal\Documents\prismo - Copy\resources\views/mitra/review/review.blade.php ENDPATH**/ ?>