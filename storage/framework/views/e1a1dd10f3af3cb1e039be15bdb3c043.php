...
<head>
  ...
  <!-- Sambungkan CSS -->
  <link rel="stylesheet" href="<?php echo e(asset('css/kelolaadmin.css')); ?>">
</head>
<body>
  <div class="container">
      ...
      <div class="header__content">
        <div class="header__left">
          <div class="header__brand">
            ...
            <img src="<?php echo e(asset('images/logo.png')); ?>" alt="PRISMO" class="logo" />
          </div>
        </div>
...
<div class="modal-overlay" id="modalAdd">
  ...
  <script>
    ...
    window.adminsData = <?php echo json_encode($admins, 15, 512) ?>;
  </script>
  <script src="<?php echo e(asset('js/kelolaadmin.js')); ?>"></script>
</body>
</html>
<?php /**PATH C:\Users\Faishal\Documents\prismo - Copy\resources\views/admin/kelolaadmin/kelolaadmin.blade.php ENDPATH**/ ?>